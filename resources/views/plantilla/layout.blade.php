  ...
  <header class="header" >
    <nav class="navbar navbar-expand-md navbar-dark justify-content-center fixed-top"
      ...
      <a class="navbar-brand " href="#">
        <img src="{{URL::asset('image/1.png')}}" width="250" height="100" class="d-inline-block align-top" alt="">
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarCollapsed">
        <ul class="navbar-nav ms-auto w-100 justify-content-end">
          <a class="nav-link m-3 text-warning" href="/"><h5><strong>Inicio</strong></h5></a>
          <a class="nav-link m-3 text-warning" href="/Productos-Servicios"><h5><strong>Productos y Servicios</strong></h5></a>
          <a class="nav-link m-3 text-warning" href="/SobreNosotros"><h5><strong>Quienes Somos</strong></h5></a>
          <a class="nav-link m-3 text-warning" href="/Cobertura"><h5><strong>Cobertura</strong></h5></a>
          <a class="nav-link m-3 text-warning" href="/Contacto"><h5><strong>Contactenos</strong></h5></a>
        </ul>
      </div>
    </nav>
  </header>
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
          ...
          <ul class="list-unstyled mb-0">
            ...
            <li>
              <a href="#!" class="text-white">Cobertura</a>
            </li>
            <li>
              <a href="#!" class="text-white">Soporte</a>
            </li>
            <li>
              <a href="#!" class="text-white">Contáctenos</a>
            </li>
          </ul>
        </div>
        <!--Grid column-->
        ...
        <!--Grid column-->
        <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
          <h5 class="text-uppercase mb-0">PRODUCTOS Y SERVICIOS</h5>
